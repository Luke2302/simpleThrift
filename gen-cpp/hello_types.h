...
typedef struct _helloStruct__isset {
  _helloStruct__isset() : num1(false), num2(false), string1(false) {}
  bool num1 :1;
  bool num2 :1;
  bool string1 :1;
} _helloStruct__isset;

class helloStruct : public virtual ::apache::thrift::TBase {
 public:

  helloStruct(const helloStruct&);
  helloStruct& operator=(const helloStruct&);
  helloStruct() : num1(0), num2(0), string1() {
  }

  virtual ~helloStruct() noexcept;
  int32_t num1;
  int32_t num2;
  std::string string1;
